  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-12 gap-3">
        {/* Deployments table — 8 cols */}
        <div className="col-span-8 border border-border-default rounded-md bg-bg-secondary overflow-hidden">
            ...
            <tbody>
              {recentDeploys.map(d => (
                <tr key={d.id} className="border-b border-border-default last:border-0 hover:bg-bg-tertiary transition-colors duration-150">
                  ...
                  <td className="px-3 py-1.5 text-right">
                    <span className="text-text-tertiary" title={d.created_at}>
              ...
              <div key={entry.id} className="flex items-start gap-2.5 px-3 py-2 hover:bg-bg-tertiary transition-colors duration-150">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    ...
                    <span className="text-[11px] text-text-tertiary" title={entry.timestamp}>
